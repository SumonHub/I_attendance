...
--
-- Host: localhost
-- Generation Time: Feb 28, 2021 at 01:27 PM
...
(19, 1, '2021-02-04', '11:32:13', NULL, '29 Rd 11, Dhaka 1212, Bangladesh', NULL, 1),
(20, 1, '2021-02-15', '14:10:39', '14:10:55', '57 Gulshan Badda Link Rd, Dhaka 1212, Bangladesh', '57 Gulshan Badda Link Rd, Dhaka 1212, Bangladesh', 2),
(21, 1, '2021-02-28', '03:28:23', '05:34:05', 'Jabbar Tower, Gulshan Avenue, 42 বীর উত্তম মীর শওকত সড়ক, ঢাকা 1212, Bangladesh', 'Jabbar Tower, Gulshan Avenue, 42 বীর উত্তম মীর শওকত সড়ক, ঢাকা 1212, Bangladesh', 2),
(22, 1, '2020-02-28', '00:00:03', '00:00:03', 'office', 'office', 2);
...
CREATE TABLE `leave_history` (
  ...
  `max_type_no` int(11) DEFAULT NULL COMMENT 'max no of typed_id',
  `status` enum('0','1','2') DEFAULT NULL COMMENT 'pending = 0\r\napproved = 1\r\ndecline = 2',
...
(54, 25, '2021-02-28', 'dfgdfgdfgdfg', '2021-02-28', '2021-03-05', 1, NULL, '0', '2021-02-28 12:16:07'),
(55, 25, '2021-02-28', 'dfgdfgdfgdfg', '2021-02-28', '2021-03-05', 1, NULL, NULL, '2021-02-28 12:18:45'),
(56, 25, '2021-02-28', 'dfgdfgdfgdfg', '2021-02-28', '2021-03-05', 1, 2, NULL, '2021-02-28 12:19:46'),
(57, 1, '2021-02-28', 'tfhfghfghfghfghfgh', '2021-02-28', '2021-03-04', 24, 1, NULL, '2021-02-28 12:23:00');
...
INSERT INTO `leave_type` (`id`, `name`, `balance`) VALUES
(1, 'Sick leave', '15'),
(2, 'Earn', '16'),
(3, 'Casual', '10'),
(19, 'testupdate12', '123'),
...
--
ALTER TABLE `leave_history`
  ADD CONSTRAINT `leave_history_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `leave_type` (`id`) ON DELETE SET NULL;
