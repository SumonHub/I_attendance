...
$app->post('/login', function (Request $request, Response $response) {
    ...
    if ($result = $db->getUserByCredential($param['uid'], $param['password'])) {
        ...
        $feedback['msg'] = "Successfully login";
        ...
        // $tmp['info'] = array();
        // $tmp1['f_name'] = $result['f_name'];
        // $tmp1['m_name'] = $result['m_name'];
        // $tmp1['dob'] = $result['dob'];
        // $tmp1['religion'] = $result['religion'];
        // $tmp1['gender'] = $result['gender'];
        // $tmp1['marital_status'] = $result['marital_status'];
        // $tmp1['nationality'] = $result['nationality'];
        // $tmp1['nid_no'] = $result['nid_no'];
        // $tmp1['phone'] = $result['phone'];
        // $tmp1['email'] = $result['email'];
        // $tmp1['blood_group'] = $result['blood_group'];
        // array_push($tmp["info"], $tmp1);
...
$app->post('/createUser', function (Request $request, Response $response) {
    ...
    if ($db->createUser($param)) {
        ...
        $feedback['error'] = false;
        $feedback['msg'] = "Successfully create account";
        $feedback["results"] = array();
        ...
        if (!$uploaded) {
            $feedback['error'] = true;
            $feedback['msg'] = "CV uploaded failed.";
            $feedback["results"] = array();
        }
        ...
        $feedback['error'] = true;
        $feedback['msg'] = "Cann't create account!";
